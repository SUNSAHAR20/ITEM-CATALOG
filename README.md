...
From the terminal, run:
    ...
    git clone https://github.com/SUNSAHAR20/ITEM-CATALOG 
...
Using the terminal, change directory to OAuth2.0 (**cd ITEM-CATALOG**), then type **vagrant up** to launch your virtual machine.
